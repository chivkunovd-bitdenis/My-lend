...
const projects = [
  {
    ...
    solution: "Система получает данные кабинета по API Wildberries и собирает слой управленческой логики поверх сырых отчётов. Продукт доступен как SellerFocus: sellerfocus.pro.",
